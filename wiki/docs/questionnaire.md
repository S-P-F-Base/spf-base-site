...
| Баффы                       | Опционально                                    | Смотреть выше по странице                                 |
| Дебаффы                     | Обязательно, если есть баффы, иначе Опционально| Смотреть выше по странице                                 |
| Навыки                      | Обязательно                                    | Навыки которыми владеет ваш персонаж                      |
| Предыстория                 | Опционально                                    | Предыстория вашего персонажа                              |
| Ссылка на модель            | Обязательно                                    | Модель персонажа для игры. См. [лимиты](/wiki/docs/limits)|
| Ссылка на ваш Steam профиль | Обязательно                                    |                                                           |
| Музыка / Арт и т.п.         | Опциональною                                   | Дополнительные материалы для атмосферы                    |
