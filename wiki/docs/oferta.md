...
5.4 — Возврат средств, как правило, не производится, если услуга уже предоставлена. Тем не менее `Исполнитель` может принять индивидуальное решение о возврате в соответствии с пунктом 5.1.
...
7.4 — `Исполнитель` не осуществляет сбор персональных данных, не связанных с оказанием услуг (в том числе паспортных данных, номеров банковских карт и т.п.).
